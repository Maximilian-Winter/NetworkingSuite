...
int main() {
    ...
    server.addRoute("/", [](const std::string& method, const std::unordered_map<std::string, std::string>& headers, const std::string& body, const std::unordered_map<std::string, std::string>& query_params, const std::unordered_map<std::string, std::string>& route_params, std::string& response, std::unordered_map<std::string, std::string>& response_headers) {
